...
1. Go to [https://www.kaggle.com/datasets/...](https://www.kaggle.com/datasets/) and search for **NetsLab-5GORAN-IDD**.
...
| Classes used | benign, ddos, dos, probe, web (bruteforce excluded — see notebook Section 5b) |
